...
dt          = 0.01;          % \delta t
lambda      = 0.003;         % \lambda
performance_test = true;     % Set to true to turn off all unecessary computations.
...
input_file = 'cameraman.jpg';                                % Input files are under ./input
initial_contour_filename = 'cameraman_init_2phase_recs.txt'; % Used only if read from file.
